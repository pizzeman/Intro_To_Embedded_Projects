...
#define RGB_LED_RED_INDEX       PB26INDEX
#define RGB_LED_GREEN_INDEX     PB27INDEX
#define RGB_LED_BLUE_INDEX      PB22INDEX
...
// RGB LED port register and mask
#define RGB_LED_RED_PIN 26
#define RGB_LED_GREEN_PIN 27
#define RGB_LED_BLUE_PIN 22

#define RGB_LED_RED_MASK ((uint32_t) (0x00000001U << RGB_LED_RED_PIN))
#define RGB_LED_GREEN_MASK ((uint32_t) (0x00000001U << RGB_LED_GREEN_PIN))
#define RGB_LED_BLUE_MASK ((uint32_t) (0x00000001U << RGB_LED_BLUE_PIN))

#define RGB_LED_RED_PORT GPIOB
#define RGB_LED_GREEN_PORT GPIOB
